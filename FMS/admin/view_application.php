                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select name="academic_supervisor_id" id="academicSupervisorSelect" class="form-control">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select name="industrial_supervisor_id" id="industrialSupervisorSelect" class="form-control">
                                                <option value="">— None —</option>
                                            </select>
                                        </div>
                                    </div>
